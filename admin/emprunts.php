...
$sql = "SELECT id , pseudo ,titre_livre, date_emprunt FROM emprunt";
$stmt = $pdo->query($sql);
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="livres.php">les livres</a></li>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $emprunt['pseudo']; ?></td>
                                            <td><?php echo $emprunt['titre_livre']; ?></td>
                                            <td><?php echo $emprunt['date_emprunt']; ?><button style="margin-left: 20px;color:white;background-color:red;" name="delete" type="submit">Delete</button></td>
    ...
    <div class="row justify-content-center"> <!-- Formulaire d'ajout de livre --> 
        <div class="col-12 col-md-8 col-lg-6"> <div class="contact-form"> 
            <h5>supprimer un emprunt</h5> <!-- Formulaire -->
             <form action="emprunts.php" method="post"> 
                <div class="row"> <!-- Titre --> 
                    <div class="col-12"> 
                                    <div class="group">
                                    <input type="text" name="Netudiant" id="Netudiant" required>
                                <span class="highlight"></span> <span class="bar"></span> 
                                <label>pseudo</label> </div> </div> <!-- Auteur --> 
                                <div class="col-12"> <div class="group">
                                <input type="text" name="titre_livre" id="titre_livre" required> 
                                <span class="highlight"></span> <span class="bar"></span> 
                                <label>titre_livre</label>
                                <div class="col-12"> <div class="group">
                                <input type="text" name="date_emprunt" id="date_emprunt" required> 
                                <span class="highlight"></span> <span class="bar"></span> 
                                <label>date_emprunt</label> 
                                </div> </div> 

                                <div class="col-12"> <button style="color:white; background-color: red;" type="submit"  name="delete" class="btn original-btn">supprimer</button>
                        </div> 
                        </div> 
                    </form>
                 </div> 
