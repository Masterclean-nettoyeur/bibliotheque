    ...
    <header class="header-area">
        ...
        <div class="logo-area text-center">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <a href="page_principale.php" class="original-logo"><h1>Bibliotheque</h1></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <!-- ##### Post Content Area ##### -->
                    ...
                    <div class="blog-post-author mt-100 d-flex">
                        <div class="author-thumbnail">
                            <img src="img/bg-img/b6.jpg" alt=""width="100" height="50">
                        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | created   <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">doudou mbaye</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
